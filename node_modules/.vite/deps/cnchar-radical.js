...
// node_modules/cnchar-radical/cnchar.radical.min.js
var require_cnchar_radical_min = __commonJS({
  "node_modules/cnchar-radical/cnchar.radical.min.js"(exports, module) {
    !(function(a, b) {
      "object" == typeof exports && "object" == typeof module ? module.exports = b() : "function" == typeof define && define.amd ? define([], b) : "object" == typeof exports ? exports.cncharRadical = b() : a.cncharRadical = b();
    })(exports, (function() {
      return (function(a) {
        var b = {};
        function d(c) {
          if (b[c]) return b[c].exports;
          var e = b[c] = { i: c, l: false, exports: {} };
          return a[c].call(e.exports, e, e.exports, d), e.l = true, e.exports;
        }
        return d.m = a, d.c = b, d.d = function(a2, b2, c) {
          ...
          if (1 & b2 && (a2 = d(a2)), 8 & b2) return a2;
          if (4 & b2 && "object" == typeof a2 && a2 && a2.__esModule) return a2;
          var c = /* @__PURE__ */ Object.create(null);
          if (d.r(c), Object.defineProperty(c, "default", { enumerable: true, value: a2 }), 2 & b2 && "string" != typeof a2) for (var e in a2) d.d(c, e, (function(b3) {
            return a2[b3];
          }).bind(null, e));
          return c;
        }, d.n = function(a2) {
        ...
        "use strict";
        d.r(b);
        var c = d(1), e = d(0), r = function() {
          for (var a2 = 0, b2 = 0, d2 = arguments.length; b2 < d2; b2++) a2 += arguments[b2].length;
          var c2 = Array(a2), e2 = 0;
          for (b2 = 0; b2 < d2; b2++) for (var r2 = arguments[b2], n2 = 0, h2 = r2.length; n2 < h2; n2++, e2++) c2[e2] = r2[n2];
          return c2;
        };
        var n, h = c;
        function t(a2) {
          var b2;
          return n && n.hasPlugin("trad") ? o(null === (b2 = n.trad.dict) || void 0 === b2 ? void 0 : b2.radical, a2) : null;
        }
        function o(a2, b2) {
          for (var d2 in a2) {
            var c2 = a2[d2], r2 = c2.indexOf(b2);
            if (-1 !== r2) {
              var n2 = e[c2.substr(r2 + 1, 1)];
              return "*" === d2 ? { radicalCount: parseInt(c2.substr(r2 + 2, 2)), radical: b2, struct: n2 } : { radicalCount: parseInt(c2.substring(0, c2.indexOf(":"))), radical: d2, struct: n2 };
            }
          }
        ...
        function g(a2, b2) {
          ...
          if (!d2) return (function() {
            for (var a3 = [], b3 = 0; b3 < arguments.length; b3++) a3[b3] = arguments[b3];
            console.warn.apply(console, r(["CnChar Warning:"], a3));
          })("错误的偏旁部首：" + a2), [];
          var c2 = d2.indexOf(":") + 1, n2 = 2;
          "*" === a2 && (c2 = 0, n2 = 3);
          for (var h2 = [], t2 = c2; t2 < d2.length; t2 += n2) "*" === a2 && 3 === n2 && /[0-9]{2}/.test(d2.substr(t2 + 2, 2)) && (n2 = 4), h2.push({ word: d2[t2], struct: e[d2[t2 + 1]] });
          return h2;
        }
        var u = Object.assign((function(a2) {
          for (var b2 = [], d2 = 0; d2 < a2.length; d2++) {
            var c2 = o(h, a2[d2]);
            c2.radical || (c2 = t(a2[d2]) || c2), b2.push(c2);
          }
          return b2;
          ...
          n._.mapJson(a2, b2, (function(a3, b3) {
            a3.length > 1 && (a3 = a3[0]), -1 !== Object.values(c).join("").indexOf(a3) && (function(a4) {
              for (var b4 in h) if (-1 !== h[b4].indexOf(a4)) return void (h[b4] = h[b4].replace(new RegExp(a4 + "[a-z][0-9]{0,2}"), ""));
            })(a3), (function(a4, b4) {
              var d2 = b4.radical, c2 = b4.struct, r2 = b4.radicalCount, n2 = (function(a5, b5) {
                for (var d3 in a5) if (a5[d3] === b5) return d3;
                return "";
              })(e, c2);
              n2 || (n2 = "*", console.warn("struct [" + c2 + "] not found in " + JSON.stringify(Object.values(e))));
              a4 === d2 ? h["*"] += "" + a4 + (n2 || "*") + (r2 || 0) : h[d2] ? h[d2] += "" + a4 + n2 : h[d2] = r2 + ":" + a4 + n2;
            })(a3, b3);
          }));
        }, getRadicalCount: function(a2) {
          return i(a2) ? parseInt(h[a2][0]) : 0;
        }, radicalToWord: function(a2, b2) {
          var d2;
          void 0 === b2 && (b2 = false);
          var c2 = g(a2, h);
          return b2 && n && n.hasPlugin("trad") ? c2.concat(g(a2, null === (d2 = n.trad.dict) || void 0 === d2 ? void 0 : d2.radical)) : c2;
        }, isRadical: i, dict: { radical: c, struct: e } });
...
export default require_cnchar_radical_min();
//# sourceMappingURL=cnchar-radical.js.map
