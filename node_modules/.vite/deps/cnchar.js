    ...
    !(function(n, e) {
      ...
      return (function(n) {
        ...
        return r.m = n, r.c = e, r.d = function(n2, e2, o) {
          ...
          if (1 & e2 && (n2 = r(n2)), 8 & e2) return n2;
          if (4 & e2 && "object" == typeof n2 && n2 && n2.__esModule) return n2;
          var o = /* @__PURE__ */ Object.create(null);
          if (r.r(o), Object.defineProperty(o, "default", { enumerable: true, value: n2 }), 2 & e2 && "string" != typeof n2) for (var t in n2) r.d(o, t, (function(e3) {
            return n2[e3];
          }).bind(null, t));
          return o;
        }, r.n = function(n2) {
        ...
        "use strict";
        r.r(e);
        var o, t = { spell: r(0), stroke: r(1), spellDefault: r(2), info: r(3) }, i = { simple: "simple", trad: "trad", poly: "poly", alltone: "alltone", array: "array" }, a = function(n2) {
          var e2 = t.info.initial;
          n2 = n2.toLowerCase();
          var r2 = o.removeTone(n2, false);
          if (-1 === r2.index) {
            if (!t.spell[r2.spell]) throw new Error("【spellInfo】错误的拼音: " + n2 + ", 请检查字符是否正确");
            r2.index = parseInt(t.spell[r2.spell][0]) + 1;
          }
          for (var i2 = "", a2 = r2.spell, u2 = 0; u2 < e2.length; u2++) if (0 === r2.spell.indexOf(e2[u2])) {
            i2 = e2[u2], a2 = r2.spell.substr(i2.length);
            break;
          }
          return { spell: r2.spell, tone: r2.tone, index: r2.index, initial: i2, final: a2 };
        };
        var u = function() {
          for (var n2 = 0, e2 = 0, r2 = arguments.length; e2 < r2; e2++) n2 += arguments[e2].length;
          var o2 = Array(n2), t2 = 0;
          for (e2 = 0; e2 < r2; e2++) for (var i2 = arguments[e2], a2 = 0, u2 = i2.length; a2 < u2; a2++, t2++) o2[t2] = i2[a2];
          return o2;
        };
        function l() {
        ...
        var s = function(n2, e2, r2) {
          if ("object" != typeof n2) r2(n2, e2);
          else for (var o2 in n2) r2(o2, n2[o2]);
        };
        function f(n2, e2) {
          if (void 0 === e2 && (e2 = 1), !n2 || 0 === n2.length || 0 === e2) return [];
          if (e2 >= n2.length) return c(Object.assign([], n2));
          for (var r2 = [], o2 = n2.length, t2 = []; t2.length < e2; ) {
            var i2 = p(0, o2 - 1);
            t2.includes(i2) || (t2.push(i2), r2.push(n2[i2]));
          }
          return r2;
        }
        function c(n2) {
          for (var e2, r2, o2 = n2.length; o2; ) r2 = Math.floor(Math.random() * o2--), e2 = n2[o2], n2[o2] = n2[r2], n2[r2] = e2;
          return n2;
        }
        function p(n2, e2) {
        ...
        function x(n2, e2) {
          ...
          E("spell", o2);
          var i2 = d(o2, y.poly), a2 = d(o2, y.tone), u2 = [];
          for (var l2 in n2) for (var s2 = n2[l2], f2 = parseInt(s2[0]), c2 = function(n3) {
            ...
            if (h(e3)) {
              ...
              if (-1 !== c3) {
                var p3 = T(l2, s2, c3, i2, a2, f2);
                if (p3.poly) {
                  u2[n3] || (u2[n3] = []), o3(p3.res);
                  for (var d2 = s2, g3 = d2.match(new RegExp(e3, "g")).length, v3 = 1; v3 < g3; v3++) c3 = (d2 = d2.substr(c3 + 2)).indexOf(e3), o3(T(l2, d2, c3, i2, a2, f2).res);
                } else p3.isPolyWord && t.spellDefault[e3] && (p3.res = S(t.spellDefault[e3], a2).spell), u2[n3] = [p3.res], r2[n3] = "";
              }
            } else "" !== e3 && (u2[n3] = ["NOT_CNCHAR", e3]);
          }, p2 = 0; p2 < r2.length; p2++) c2(p2);
          w(u2, o2);
          var g2 = [];
        ...
        function T(n2, e2, r2, o2, t2, i2) {
          var a2 = parseInt(e2[r2 + 1]), u2 = { res: n2, poly: false, isPolyWord: a2 >= 5 };
          return o2 || t2 ? (u2.isPolyWord && (a2 -= 5, o2 && (u2.poly = true)), t2 && (u2.res = _(n2, i2, a2)), u2) : u2;
        }
        function C(n2, e2) {
        ...
        var S = function(n2, e2) {
          if (e2) return { spell: n2 };
          for (var r2 = 0; r2 < n2.length; r2++) {
            var o2 = v.indexOf(n2[r2]);
            if (-1 !== o2) return { spell: n2.substr(0, r2) + "aoeiuün"[Math.floor(o2 / 4)] + n2.substr(r2 + 1), tone: o2 % 4 + 1, index: r2 + 1 };
          }
        ...
        function q(n2, e2) {
          ...
          for (var i2 in E("stroke", t2), n2) for (var a2 = 0; a2 < r2.length; a2++) r2[a2] && -1 !== n2[i2].indexOf(r2[a2]) && (r2[a2] = "", o2[a2] = parseInt(i2));
        ...
        var W = function(n2) {
          ...
          if (g.check) if (A) A = false;
          else {
            r2 && (A = true);
            for (var o2 = [], t2 = e2.length - 1; t2 >= 0; t2--) {
              var i2 = e2[t2];
              g.type[n2][i2] || (o2.push(i2), e2.splice(t2, 1));
            }
            var a2 = [], u2 = [], l2 = function(n3, r3) {
              void 0 === r3 && (r3 = a2), n3 instanceof Array ? n3.forEach((function(n4) {
                l2(n4, r3);
              })) : d(e2, n3) && r3.push(n3);
            };
            -1 === g.plugins.indexOf("trad") && (d(e2, "simple") && a2.push("simple"), d(e2, "trad") && a2.push("trad")), "spell" === n2 ? d(e2, "up") && d(e2, "low") && a2.push("low") : "stroke" === n2 ? d(e2, "order") ? (l2("array", u2), d(e2, "letter") ? (l2(["detail", "shape", "name", "count"]), l2("letter", u2)) : d(e2, "detail") ? l2(["shape", "name", "count"]) : d(e2, "shape") ? l2(["name", "count"]) : d(e2, "name") && l2(["count"])) : (l2(["detail", "shape", "name", "letter"]), l2("count", u2)) : "orderToWord" === n2 ? d(e2, "match") ? l2(["matchorder", "contain", "start"]) : d(e2, "matchorder") ? l2(["contain", "start"]) : d(e2, "contain") && l2(["start"]) : "strokeToWord" === n2 || "spellToWord" === n2 || "idiom" === n2 && (d(e2, "spell") ? l2(["stroke", "char"]) : d(e2, "stroke") ? l2(["tone", "char"]) : l2(["tone"])), N(o2, "无效", n2, e2), N(a2, "被忽略", n2, e2), N(u2, "冗余", n2, e2);
          }
        };
        ...
        function P(n2, e2) {
          ...
          if (!e2) return r2 ? I(n2, true, "low").spell : n2;
          if (r2) return n2;
        ...
        var I = function(n2, e2, r2) {
          ...
          var o2, t2, i2 = n2[n2.length - 1], u2 = -1, l2 = false;
          parseInt(i2).toString() === i2 ? (n2 = n2.substr(0, n2.length - 1), u2 = (t2 = a(n2)).index, o2 = parseInt(i2), l2 = true, e2 && (n2 = _(n2, u2 - 1, o2))) : (u2 = (t2 = a(n2)).index, o2 = t2.tone, e2 || 0 === o2 || (n2 = t2.spell));
          return "low" === r2 ? n2 = n2.toLowerCase() : "up" === r2 && (n2 = n2.toUpperCase()), { spell: n2, tone: o2, index: u2, isTrans: l2 };
        };
        var R = function(n2) {
          var e2 = n2.target, r2 = n2.key, o2 = n2.value, t2 = n2.isSpell, i2 = void 0 !== t2 && t2;
          s(r2, o2, (function(n3, r3) {
            n3 && r3 && (e2[n3] = i2 ? P(r3) : r3);
          }));
        };
        function M(n2, e2, r2, o2, i2) {
          if (void 0 === i2 && (i2 = false), "object" != typeof r2) if (o2 instanceof Array) o2.forEach((function(o3) {
            M(n2, e2, r2, o3, true);
          }));
          else {
            var a2 = I(o2), u2 = n2[a2.spell];
            if ((e2 = e2).length >= 1) {
              for (var l2 = 0; l2 < e2.length; l2++) {
                var s2 = e2[l2];
                if (s2.spell === a2.spell && s2.tone === a2.tone) return;
              }
              i2 || (i2 = true);
            }
            var f2 = "" + r2 + (a2.tone + (i2 ? 5 : 0));
            if (n2[a2.spell] = u2 ? u2 + f2 : a2.index + ":" + f2, 1 === e2.length) {
              var c2 = e2[0];
          ...
          else for (var p2 in r2) M(n2, e2[p2], p2, r2[p2]);
        }
        function D(n2, e2) {
        ...
        function U(n2) {
          ...
          if ("number" != typeof n2 || n2 <= 0) throw new Error("strokeToWord: 输入必须是正整数");
          J.checkArgs("strokeToWord", e2);
          var o2 = "", i2 = { simple: J.has(e2, H.simple), trad: J.has(e2, H.trad) };
          return i2.simple || i2.trad || (i2.simple = i2.trad = true), i2.simple && (o2 += B(n2, t.stroke)), i2.trad && J.dict.getTradCount && (o2 += B(n2, J.dict.getTradCount())), J.has(e2, H.array) ? o2.split("") : o2;
        }
        function B(n2, e2) {
        ...
        var F = [];
        function X(n2, e2) {
          if (void 0 === e2 && (e2 = false), !e2) return n2.charCodeAt(0);
          var r2 = (function(n3) {
        ...
        function K(n2) {
          Y = n2, (function(n3) {
            L = n3, "aoeiuvn".split("").forEach((function(n4) {
              for (var e2 = n4.charCodeAt(0), r2 = 1; r2 <= 4; r2++) F.push(e2 + 0.1 * r2);
            }));
          })(n2);
        }
        ...
        function en(n2, e2) {
          var r2 = ["low"];
          if (e2 && r2.push("tone"), Y.isCnChar(n2)) return Y.spell.apply(Y, Z([n2], r2));
          try {
        ...
        function rn(n2, e2, r2) {
          if (void 0 === r2 && (r2 = false), !(n2 = en(n2, r2))) return Q;
          if (!(e2 = en(e2, r2))) return V;
          for (var o2 = 0; o2 < n2.length; o2++) {
            if (!e2[o2]) return Q;
            var t2 = X(n2[o2], r2), i2 = X(e2[o2], r2);
            if (t2 > i2) return Q;
            if (t2 < i2) return V;
          }
        ...
        var sn = "object" == typeof wx && "object" == typeof __wxConfig ? "miniapp" : "object" == typeof window ? "web" : "node", fn = function() {
          return (fn = Object.assign || function(n2) {
            for (var e2, r2 = 1, o2 = arguments.length; r2 < o2; r2++) for (var t2 in e2 = arguments[r2]) Object.prototype.hasOwnProperty.call(e2, t2) && (n2[t2] = e2[t2]);
            return n2;
        ...
        var dn, gn, vn, yn, mn, xn = fn(fn({ env: sn, version: "3.2.6", spell: pn, stroke: hn, check: true, _origin: { spell: pn, stroke: hn }, plugins: an, hasPlugin: function(n2) {
          ...
          n2.forEach((function(n3) {
            ...
            if (e3) {
              if (un(e3)) {
                var i2 = r2;
                t2 && (i2.type[e3] = t2), n3.getCnChar = function() {
                  return r2;
                }, n3.installed = true, i2[e3] = n3, o2 && o2(r2);
              }
            } else l("plugin name is required", n3);
          }));
          ...
          if (-1 === e2.indexOf("trad") || -1 === g.plugins.indexOf("trad")) return n2;
          var r2 = false;
          ...
          var t2 = -1 !== e2.indexOf($), i2 = -1 !== e2.indexOf(G), a2 = i2 ? -1 : 1, u2 = -1 * a2, l2 = n2.sort((function(n3, e3) {
            var r3 = rn(n3, e3, t2);
            return r3 === Q ? a2 : r3 === V ? u2 : 0;
          }));
          return o2 ? l2.join("") : l2;
        }, sortStroke: function(n2, e2) {
          var r2 = false;
          "string" == typeof n2 && (n2 = n2.split(""), r2 = true);
          var o2 = e2 === G ? -1 : 1, t2 = -1 * o2, i2 = n2.sort((function(n3, e3) {
            var r3 = on(n3, e3);
            return r3 === Q ? o2 : r3 === V ? t2 : 0;
          }));
          return r2 ? i2.join("") : i2;
        }, setSpellDefault: function(n2, e2) {
          R({ target: t.spellDefault, key: n2, value: e2, isSpell: true });
        }, setSpell: function(n2, e2) {
          !(function(n3, e3, r2) {
            var o2;
            if ("object" == typeof e3) for (var t2 in o2 = {}, e3) o2[t2] = D(n3, t2);
            else o2 = D(n3, e3);
            M(n3, o2, e3, r2);
          })(t.spell, n2, e2);
          ...
          if ("string" != typeof r2) throw new Error("spellToWord: 输入必须是字符串");
          var a2 = o.transformTone(r2, false), u2 = n2.splice(1);
          o.checkArgs("spellToWord", u2);
          var l2 = { simple: o.has(u2, i.simple), trad: o.has(u2, i.trad), poly: o.has(u2, i.poly), alltone: o.has(u2, i.alltone) };
          l2.simple || l2.trad || (l2.simple = l2.trad = true);
          for (var s2 = "", f2 = t.spell[a2.spell].substr(2), c2 = 0; c2 < f2.length; c2 += 2) {
            var p2 = f2[c2], h2 = parseInt(f2[c2 + 1]), d2 = h2 > 4;
            d2 && (h2 -= 5), -1 !== s2.indexOf(p2) || !l2.alltone && h2 !== a2.tone || l2.poly && !d2 || (s2 += p2);
          }
          ...
          return o.has(u2, i.array) ? s2.split("") : s2;
        }, strokeToWord: U, spellInfo: a, setResourceBase: function(n2) {
          var e2 = this;
        ...
        }, g = xn, o = (mn = xn)._, a.tones = o.tones.split(""), a.initials = t.info.initial, mn.spellInfo = a, mn.type.spellToWord = i, (function(n2) {
